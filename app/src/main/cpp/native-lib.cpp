...
jobject J_FIND_TIMBER_CONTOURS(jobject data_juv420_n12, jint width, jint height, jint resizelvl, jdouble normlvl, jint closelvl, jint openlvl, jdouble markerlvl, jboolean bg_enable_filtering)  {
